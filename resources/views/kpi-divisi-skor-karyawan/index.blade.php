    ...
    <div class="container py-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-2">Skor KPI Divisi — Per Karyawan</h5>

                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    {{-- Per Page --}}
                    <form method="GET" action="{{ route('kpi-divisi.skor-karyawan.index') }}"
                    ...
                    <form method="GET" action="{{ route('kpi-divisi.skor-karyawan.index') }}"
                        ...
                        <a href="{{ route('kpi-divisi.skor-karyawan.index', ['per_page' => $perPage]) }}"
            ...
            <div class="card-body">
                    ...
                    <table class="table-hover table align-middle">
                        ...
                        <tbody>
                            ...
                            @if (is_null($bulan) || is_null($tahun))
                                <tr>
                                    <td colspan="10" class="text-muted py-4 text-center">Silakan pilih Bulan & Tahun
                                        terlebih dahulu.</td>
                                </tr>
                            @else
                                @forelse ($users as $i => $u)
                                    @php $row = $rows[$u->id] ?? null; @endphp
                                    <tr>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-muted py-4 text-center">Tidak ada data.</td>
                                    </tr>
                                @endforelse
                            @endif
                        </tbody>
                ...
                @php
                    ...
                    $tot = !is_null($bulan) && !is_null($tahun) ? $users->total() : 0;
                @endphp
